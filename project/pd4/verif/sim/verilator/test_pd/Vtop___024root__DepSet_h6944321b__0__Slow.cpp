...
VL_ATTR_COLD void Vtop___024root___eval_initial__TOP(Vtop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    VL_READMEM_N(true, 768, 3298, 0, VL_CVT_PACK_STR_NW(23, Vtop__ConstPool__CONST_ha64be4ce_0)
                 ,  &(vlSelfRef.top__DOT__genblk3__DOT__pattern)
                 , 0, ~0ULL);
    vlSelfRef.top__DOT__clock = 0U;
    vlSelfRef.top__DOT__reset = 1U;
    VL_READMEM_N(true, 32, 58, 0, VL_CVT_PACK_STR_NW(21, Vtop__ConstPool__CONST_h2e0ab818_0)
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 3298; ++__Vi0) {

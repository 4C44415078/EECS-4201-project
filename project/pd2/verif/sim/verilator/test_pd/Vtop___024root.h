...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    VlUnpacked<VlWide<8>/*255:0*/, 51> top__DOT__genblk3__DOT__pattern;
    VlUnpacked<IData/*31:0*/, 51> top__DOT__dut__DOT__core__DOT__memory1__DOT__temp_memory;
    VlUnpacked<CData/*7:0*/, 204> top__DOT__dut__DOT__core__DOT__memory1__DOT__main_memory;

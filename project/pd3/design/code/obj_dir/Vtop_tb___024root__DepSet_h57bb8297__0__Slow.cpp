...
VL_ATTR_COLD void Vtop_tb___024root___ctor_var_reset(Vtop_tb___024root* vlSelf) {
    ...
    vlSelf->top_tb__DOT__hut__DOT__addr_i = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 12521309704445019484ull);
    vlSelf->top_tb__DOT__hut__DOT__data_i = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 3047511828414772417ull);

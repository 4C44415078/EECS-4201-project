...
VL_INLINE_OPT void Vtop_tb___024root___nba_sequent__TOP__1(Vtop_tb___024root* vlSelf) {
    ...
    __VdlyVal__top_tb__DOT__hut__DOT__ctrl_reg__v2 
        ...
        [1U];
    if (vlSelfRef.top_tb__DOT__rst) {
        vlSelfRef.top_tb__DOT__hut__DOT__d_reg_rs1 = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__d_reg_rs2 = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__d_reg_rs1data = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__d_reg_funct7 = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__e_reg_funct3 = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__e_reg_opcode = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__e_reg_rs2data = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__wb_reg_rd = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__wb_reg_data = 0U;
        ...
        vlSelfRef.top_tb__DOT__hut__DOT__d_reg_funct3 = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__d_reg_opcode = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__d_reg_rs2data = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__e_reg_rd = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__d_reg_imm = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__d_reg_pc = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__d_reg_rd = 0U;
        vlSelfRef.top_tb__DOT__hut__DOT__d_reg_insn = 0U;
    } else {
        vlSelfRef.top_tb__DOT__hut__DOT__d_reg_rs1 
            = vlSelfRef.top_tb__DOT__hut__DOT__d_rs1;
        vlSelfRef.top_tb__DOT__hut__DOT__d_reg_rs2 
        ...
        vlSelfRef.top_tb__DOT__hut__DOT__wb_reg_rd 
            = vlSelfRef.top_tb__DOT__hut__DOT__e_reg_rd;
        vlSelfRef.top_tb__DOT__hut__DOT__wb_reg_data 
            = ((0U == (3U & (vlSelfRef.top_tb__DOT__hut__DOT__ctrl_reg
                ...
                : ((1U == (3U & (vlSelfRef.top_tb__DOT__hut__DOT__ctrl_reg
                    ...
                    : ((2U == (3U & (vlSelfRef.top_tb__DOT__hut__DOT__ctrl_reg
                                     [2U] >> 7U))) ? 
                       ((IData)(4U) + vlSelfRef.top_tb__DOT__hut__DOT__m_reg_pc)
        ...
        vlSelfRef.top_tb__DOT__hut__DOT__d_reg_rd = 
            (((0x23U != (0x7fU & vlSelfRef.top_tb__DOT__hut__DOT__d_reg_insn)) 
                                                     ...
                                                     ((~ 
                                                      ...
                                                      & ((1U 
                                                         ...
                                                         (~ (IData)(vlSelfRef.top_tb__DOT__hut__DOT__e_alu1__DOT__breq))
                                                          : (IData)(vlSelfRef.top_tb__DOT__hut__DOT__e_alu1__DOT__breq)))));
    vlSelfRef.top_tb__DOT__hut__DOT__f_reg_insn = vlSelfRef.top_tb__DOT__hut__DOT__f_insn;
...
#endif
            VL_FATAL_MT("top_tb.sv", 20, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("top_tb.sv", 20, "", "Active region did not converge.");
            }
